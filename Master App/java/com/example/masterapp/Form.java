...
public class Form extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.button1) {
            ...
            Toast.makeText(Form.this, "Button Clicked", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chkSport.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b)
                    Toast.makeText(Form.this, "Hobby is Sports", Toast.LENGTH_SHORT).show();
            }
        });
        chkArt.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b)
                    Toast.makeText(Form.this, "Hobby is Art", Toast.LENGTH_SHORT).show();
            }
        });
        chkSocial.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b)
                    Toast.makeText(Form.this, "Hobby is Social Work", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        rdgrp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if (i == R.id.rdfemale) {
                    gender = "Female";
                    Toast.makeText(Form.this, "Gender is Female", Toast.LENGTH_SHORT).show();
                } else if (i == R.id.rdmale) {
                    gender = "Male";
                    Toast.makeText(Form.this, "Gender is Male", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back = new Intent(Form.this, masterApp.class);
                Toast.makeText(Form.this, "Back to Main Page", Toast.LENGTH_SHORT).show();
                startActivity(back);
            }
        });
    }
