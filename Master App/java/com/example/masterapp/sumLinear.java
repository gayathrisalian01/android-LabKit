...
public class sumLinear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sum_linear);
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back = new Intent(sumLinear.this, masterApp.class);
                Toast.makeText(sumLinear.this, "Back to Main Page", Toast.LENGTH_SHORT).show();
                startActivity(back);
            }
        });
